...
// SPEECHSAASPROD provides the API operation methods for making requests to
// SPEECH_SAAS_PROD. See this package's package overview docs
// for details on the service.
//
// SPEECHSAASPROD methods are safe to use concurrently. It is not safe to
...
func newClient(cfg volcengine.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *SPEECHSAASPROD {
	svc := &SPEECHSAASPROD{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
...
// newRequest creates a new request for a SPEECHSAASPROD operation and runs any
// custom request initialization.
func (c *SPEECHSAASPROD) newRequest(op *request.Operation, params, data interface{}) *request.Request {
