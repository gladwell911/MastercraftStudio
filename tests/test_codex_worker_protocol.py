...
def test_protocol_error_is_not_chat_scoped():
    message = make_worker_event("protocol_error", {"message": "bad request"})

    assert validate_chat_scoped_message(message) == message
